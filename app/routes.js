...
router.post('/upload-docs/documents', function (req, res) {
        res.redirect('https://hmcts-pcq-div-prototype.herokuapp.com/pcq-v2/introduction?respondent=false&');
});
...
function getNextAosStep(req, path) {
    ...
    switch(path) {
        ...
        case "/aos/contact-details":
            return "https://hmcts-pcq-div-prototype.herokuapp.com/pcq-v2/introduction?respondent=true&";
