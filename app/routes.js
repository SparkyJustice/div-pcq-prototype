...
router.post('/upload-docs/documents', function (req, res) {
        res.redirect('https://hmcts-pcq-div-prototype.herokuapp.com/introduction?userType=applicant');
});
...
function getNextAosStep(req, path) {
    ...
    switch(path) {
        ...
        case "/aos/contact-details":
            return "https://hmcts-pcq-div-prototype.herokuapp.com/introduction?userType=respondent";
